...
CREATE TABLE IF NOT EXISTS streamer_event_config (
  ...
  sub_message     VARCHAR(500) NOT NULL DEFAULT 'Thanks {display_name} for subscribing! ({tier_name})',
  resub_message   VARCHAR(500) NOT NULL DEFAULT 'Thanks {display_name} for {months} months! ({tier_name})',
